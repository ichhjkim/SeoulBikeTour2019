...
#     catgory = models.TextField()
columns = [ 'name','rating','explain','mapy','mapx','imagelink','address','category' ]

fieldnames = ('지명','평점','상세설명','mapy','mapx','이미지링크','주소','카테고리')
csvfilename = '데이터\\3.spotengconvert\\seoul_bikeSpots_eng.csv'
rows = [] 
...
with open('데이터\\tour_final_eng.json', 'w', encoding='utf-8') as f:
